...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOA, DS1302_CLK_Pin|LAY_HOT_Pin, GPIO_PIN_SET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOA, DS1302_DAT_Pin|DS1302_RST_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, LAY_COLD_Pin|LAY_FAN_Pin|LAY_WUHUA_Pin|DHT11_DQ_Pin, GPIO_PIN_SET);
  ...
  /*Configure GPIO pins : DS1302_CLK_Pin DS1302_DAT_Pin DS1302_RST_Pin */
  ...
  /*Configure GPIO pin : LAY_HOT_Pin */
  ...
  /*Configure GPIO pins : LAY_COLD_Pin LAY_FAN_Pin LAY_WUHUA_Pin */
  GPIO_InitStruct.Pin = LAY_COLD_Pin|LAY_FAN_Pin|LAY_WUHUA_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_PULLDOWN;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_HIGH;
  HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);
