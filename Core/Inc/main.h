...
#define LAY_HOT_Pin GPIO_PIN_15
#define LAY_HOT_GPIO_Port GPIOA
#define LAY_COLD_Pin GPIO_PIN_3
#define LAY_COLD_GPIO_Port GPIOB
#define LAY_FAN_Pin GPIO_PIN_4
#define LAY_FAN_GPIO_Port GPIOB
#define LAY_WUHUA_Pin GPIO_PIN_5
#define LAY_WUHUA_GPIO_Port GPIOB
